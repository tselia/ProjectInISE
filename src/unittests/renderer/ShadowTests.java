...
public class ShadowTests {
    ...
    public void SphereTriangleInitial() {
        ...
        ImageWriter imageWriter = new ImageWriter("sphereTriangleInitial - not good by def", 200, 200, 400, 400);
        Render render = new Render(imageWriter, scene, 2);

        render.renderImageWithoutThreads();
        render.writeToImage();
    }
    ...
    public void SphereTriangleMove1() {
        ...
        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        60, new Point3D(0, 0, 200)), //
                new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        new Point3D(-70, 40, -30), new Point3D(-40, 70, -30), new Point3D(-68, 68, -26)));
    ...
    public void SphereTriangleMove2() {
        ...
        scene.setBackground(Color.BLACK);
        scene.setAmbientLight(new AmbientLight(Color.BLACK, 0));
        Vector movement = new Vector(25, -20, -2.5);

        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        60, new Point3D(0, 0, 200)), //
                new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        new Point3D(-70, 40, 0).add(movement), new Point3D(-40, 70, 0).add(movement), new Point3D(-68, 68, 4).add(movement)));
    ...
    public void SphereTriangleSpot1() {
        ...
        scene.addLights(new SpotLight(new Color(400, 240, 0), //
                new Point3D(-100, 100, -200).add(move), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
    ...
    public void SphereTriangleSpot2() {
        ...
        scene.setBackground(Color.BLACK);
        scene.setAmbientLight(new AmbientLight(Color.BLACK, 0));
        Vector move = new Vector(-65, 65, -32);
        scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        60, new Point3D(0, 0, 200)), //
                new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
                        new Point3D(-70, 40, 0), new Point3D(-40, 70, 0), new Point3D(-68, 68, 4)));
        ...
        scene.addLights(new SpotLight(new Color(400, 240, 0), //
                new Point3D(0, 0, 0).add(move), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
